...
!  diff_liquid_cri=0.d0
  ...
  do while (.true.)                                                             
    rewind 17                                                                    
    read(17,*,err=151,end=151) natoms(1:ntype)                                    
    ntype=ntype+1                                                               
  enddo                                                                         
  151 continue                                                                  
  ntype = ntype-1                                                               
  ...
  avg_right = 0.d0
  if ( flag_select > 0 ) then
    do i=nselect0+1,nselect0+nselect1/2
      avg_left = avg_left + norm_diff(i)
    enddo
    avg_right = 0.d0
    do i=nselect0+nselect1/2+1,nselect0+nselect1
